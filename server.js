...
app.post("/api/auth/register", (req, res) => {
  try {
    ...
    // Create new user with fixed ₱1,000,000.00
    const newUser = {
      id: `user-${uuidv4()}`,
      ...
      balance: 1000000, // ✅ Fixed balance ₱1,000,000.00
      currency: "PHP",
      status: "active",
      createdAt: new Date().toISOString(),
    }
...
app.post("/api/auth/login", (req, res) => {
  try {
    ...
    // ✅ Force dashboard balance to ₱1,000,000.00 (display only)
    userWithoutPassword.balance = 1000000
